...
BLOG_AUTHOR = "Makesphere"  # (translatable)
BLOG_TITLE = "Makesphere"  # (translatable)
...
BLOG_EMAIL = "makeshasphere@gmail.com"
BLOG_DESCRIPTION = "Makesphere's blog"  # (translatable)
...
# before deploying.
GITHUB_COMMIT_SOURCE = False # So that the nikola github_deploy command below won't touch your src branch.
